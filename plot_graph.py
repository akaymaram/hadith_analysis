...
file_path = "outputs/" + file_name + ".txt"
...
def draw_circular(graph, with_labels = True):
	...
	savefig_input = "outputs/"+source_name+"_graph.png"
...
dfi.export(df_dic, "outputs/"+source_name+'_narrator_IDs.png', max_rows= len(df_dic))
plt.show()
draw_circular(graph)
